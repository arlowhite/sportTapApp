define(["require", "exports"], function (require, exports) {
    ...
    var FakeDbService = (function () {
        function FakeDbService($q) {
            'ngInject';
            "use strict";
            this.$q = $q;
            this.$q = $q;
        }
        FakeDbService.prototype.myId = function () {
            return myPersonId;
        };
        FakeDbService.prototype.person = function (id) {
            return this.$q.when(fakeUsers[id]);
        };
        FakeDbService.prototype.activity = function (id) {
        ...
        FakeDbService.prototype.myFriends = function () {
            if (!_myFriendsDef) {
        ...
        FakeDbService.prototype.invitedMe = function () {
            if (!_invitedMe) {
         ...
         * @returns {*}
         */
        FakeDbService.prototype.myActivities = function (op, rsvp) {
         ...
         * @param rsvp
         */
        FakeDbService.prototype.updateRsvp = function (activityId, rsvp) {
        ...
        FakeDbService.prototype.sportIcon = function (sportId) {
            // For now, just use ion icons since it has a few sports
            return ionIconForSport[sportId];
        };
        FakeDbService.prototype.querySports = function (text) {
