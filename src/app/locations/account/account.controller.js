define(["require", "exports"], function (require, exports) {
    var AccountController = (function () {
        function AccountController($mdDialog, $timeout, $animate, $scope, $ionicScrollDelegate, $ionicPosition, $window, $rootScope) {
            'ngInject';
            ...
            $animate.on('enter', document.getElementById('location-container'), function callback(element, phase) {
                ...
                if (element[0].id == 'location-editor') {
                    ...
                    if (phase == 'start') {
                        ...
                        var inputContainerElement = angular.element(inputContainer);
                        // offset is relative to scroll
                        var pos = $ionicPosition.offset(inputContainerElement);
        ...
        AccountController.prototype.editingProfileChanged = function (value) {
        ...
        AccountController.prototype.showLocationEditor = function (ev) {
        ...
        AccountController.prototype.hideLocationEditor = function (ev) {
        ...
        AccountController.prototype.editName = function (ev) {
            var self = this;
